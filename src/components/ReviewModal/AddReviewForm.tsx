...
// import { selectReviewById } from '@/redux/reviews/selectors';
 ...
 export const AddReviewForm: React.FC = () => {
  ...
  const [comment, setComment] = useState<string>('');
    // const [isEdit, setIsEdit] = useState<boolean>(false)
      ...
      // const review = useSelector(selectReviewById(_id))
      // console.log(review)
   ...
   const handleReviewChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    //   dispatch(updateReviewThunk(_id));
    // }
          ...
          //  type='text'
           ...
           placeholder="Ваш коментар"
            ...
            {/* <button type="button" className=" " >
             <PencilIcon className="h-8 w-8 text-salat-50 clear-hover " />
             </button> */}
